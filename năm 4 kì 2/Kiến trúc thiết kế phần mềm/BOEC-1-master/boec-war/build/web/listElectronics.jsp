...
<html>
    ...
    <body>
        <%
            if (session.getAttribute("liselec") == null) {
        %>
        <jsp:forward page="/getElectronic"></jsp:forward>
        <%
            }
        %>
        ...
        <jsp:include page="bander.jsp"></jsp:include>
            <div class="products">
            <%
                List<Electronics> lisElectronic = (List<Electronics>) session.getAttribute("liselec");
