...
<body>
    ...
    <div class="container">
        <div class="account">
            <h2 class="account-in" style="margin-left: 400px; font-size: 30px;">Thông tin giao hàng</h2>
            <form action="CheckOutServlet" method="POST">
                <div>
                    <span>Tên khách hàng*</span>
                    <input type="text" name="tenkh" style="margin-left: 80px;">
                </div> 
                <div>
                    <span>Địa chỉ giao hàng *</span>
                    <input type="text" name="address" style="margin-left: 65px;">
                </div> 	
                <div>
                    <span>Phương thức thanh toán *</span>
                    <select name="payment" style="margin-left: 10px; height: 40px;">
                        <option value="Thanh toán online" > Thanh toán online</option>
                        <option value="Thanh toán trực tiếp" > Thanh toán trực tiếp</option>
                    </select>
                </div> 			
                <input type="submit" value="Thanh toán" style="margin-left: 400px;"> 
            </form>
        </div>
    </div>

    <div class="footer" style="margin-left:50px; margin-top: 0px;">
