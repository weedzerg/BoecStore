<%-- 
    Document   : register
    Created on : 20-Dec-2017, 00:30:20
    Author     : LOAN
--%>
...
<!-- End quang cao --> 
    ...
    <body>
        ...
        <div class="container">
                <div class="account">
                    <h2 style="text-align: center;margin-bottom: 50px;">Đăng ký thông tin khách hàng</h2>
                    <form action="RegisterServlet" method="POST">
                        
                        <div>
                            <span class="word">Tên đăng nhập *</span>
                            <input type="text" name="username" style="margin-left: -6px;">
                        </div> 	
                        	
                        <div> 
                            <span class="word">Password *</span>
                            <input type="password" name="password" style="margin-left: 25px;">
                            <span></span>
                        </div>	
