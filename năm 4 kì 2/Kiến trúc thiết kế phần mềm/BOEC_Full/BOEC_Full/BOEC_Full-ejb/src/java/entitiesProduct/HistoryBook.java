...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "HistoryBook.findAll", query = "SELECT h FROM HistoryBook h")
    , @NamedQuery(name = "HistoryBook.findById", query = "SELECT h FROM HistoryBook h WHERE h.id = :id")
    , @NamedQuery(name = "HistoryBook.findByProductIdProduct", query = "SELECT h FROM HistoryBook h WHERE h.productIdProduct = :productIdProduct")})
public class HistoryBook implements Serializable {
    ...
    public HistoryBook(Long productIdProduct) {
        this.productIdProduct = productIdProduct;
    }

    public HistoryBook(Long productIdProduct, long id) {
        this.productIdProduct = productIdProduct;
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HistoryBook)) {
            return false;
        }
        HistoryBook other = (HistoryBook) object;
    ...
    public String toString() {
        return "entitiesProduct.HistoryBook[ productIdProduct=" + productIdProduct + " ]";
    }
