...
/**
 * Created by DaiPhongPC on 10/31/2017.
 */

public class TrimVideo {
    private static final String TAG = TrimVideoUtils.class.getSimpleName();

    public static Uri startTrim(File src,File dst, long startMs, long endMs) throws IOException {
        return genVideoUsingMp4Parser(src, dst, startMs, endMs);
    }
    private static Uri genVideoUsingMp4Parser( File src,File dst, long startMs, long endMs) throws IOException {
